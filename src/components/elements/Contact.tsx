        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {dataContact.map((item, index) => (
            ...
            >
              ...
              {/* Card Content */}
              <div className="relative glass-card rounded-3xl p-8 shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 md:h-58">
                {/* Icon Container */}
                ...
                <div className="text-center">
                  <h3 className="text-xl font-bold text-black mb-3 tracking-tight group-hover:text-white">
                    {item.title}
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed wrap-break-words group-hover:text-white">
                    {item.desc}
                  </p>
                </div>
